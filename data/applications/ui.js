...
export const UI = {
  en: {
    ...
    home: 'Home', hubName: 'Recipes', resourcesName: 'Resources', resourcesTitle: 'Liquid or powder? Pick the right aquafaba for your recipe', resourcesText: 'Meringue, mousse, mayo, cocktails, macarons or baking: each guide tells you which format works best, how much to use and why.', resourcesLink: 'All professional guides', cardCta: 'Read the guide',
  ...
  fr: {
    ...
    home: 'Accueil', hubName: 'Recettes', resourcesName: 'Ressources', resourcesTitle: 'Liquide ou poudre ? Choisissez le bon aquafaba pour votre recette', resourcesText: 'Meringue, mousse, mayonnaise, cocktails, macarons ou pâtisserie : chaque guide vous dit quel format convient le mieux, quelle dose utiliser et pourquoi.', resourcesLink: 'Tous les guides professionnels', cardCta: 'Lire le guide',
  ...
  nl: {
    ...
    home: 'Home', hubName: 'Recepten', resourcesName: 'Bronnen', resourcesTitle: 'Vloeibaar of poeder? Kies de juiste aquafaba voor uw recept', resourcesText: 'Meringue, mousse, mayonaise, cocktails, macarons of bakken: elke gids vertelt u welk formaat het beste werkt, hoeveel u nodig hebt en waarom.', resourcesLink: 'Alle professionele gidsen', cardCta: 'Lees de gids',
