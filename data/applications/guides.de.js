...
export default {
  "cocktails": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Geöffnetes flüssiges Aquafaba steht verschlossen im Kühlschrank bei höchstens {opened_temp} °C und wird innerhalb von {opened_days} Tagen verbraucht. Geöffnetes Pulver hält sich, solange der Beutel trocken und verschlossen bleibt. Ungeöffnet sind beide Formate {unopened_months} Monate bei Raumtemperatur haltbar."
      },
      {
      ...
      },
      {
        ...
        "a": "{powder_parts} Teil Pulver auf {water_parts} Teile Wasser, nach Gewicht. Für einen Drink sind das {powder_dose} g Pulver und {water_dose} g Wasser. Rühren Sie es vorab an und stellen Sie es bis zum Service kalt. Die Faustregel pro Eiweiß: {white_powder} g Pulver + {white_water} ml Wasser = 1 Eiweiß = {white_liquid} g flüssiges Aquafaba."
      },
      {
  ...
  "meringue": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Geöffnetes flüssiges Aquafaba wird verschlossen bei höchstens {opened_temp} °C gelagert und innerhalb von {opened_days} Tagen verbraucht. Geöffnetes Pulver hält sich, solange der Beutel trocken und verschlossen bleibt. Ungeöffnet sind beide Formate {unopened_months} Monate bei Raumtemperatur haltbar."
      },
      {
      ...
      },
      {
        ...
        "a": "{powder_parts} Teil Pulver auf {water_parts} Teile Wasser, nach Gewicht. Für einen Ansatz sind das {powder_dose} g Pulver und {water_dose} g Wasser. Kühlen Sie die Mischung auf {chill} °C, bevor sie in die Maschine kommt. Die Faustregel pro Eiweiß: {white_powder} g Pulver + {white_water} ml Wasser = 1 Eiweiß = {white_liquid} g flüssiges Aquafaba."
      },
      {
  ...
  "chocolate-mousse": {
    ...
    "faq": [
      ...
      {
        "q": "Wie rühre ich das Pulver für einen Ansatz an?",
        "a": "{powder_parts} Teil Pulver auf {water_parts} Teile Wasser, nach Gewicht. Für einen Ansatz sind das {powder_dose} g Pulver und {water_dose} g Wasser. Kühlen Sie die Mischung, bevor sie in die Maschine kommt. Die Faustregel pro Eiweiß: {white_powder} g Pulver + {white_water} ml Wasser = 1 Eiweiß = {white_liquid} g flüssiges Aquafaba."
      },
      {
  ...
  "mayonnaise": {
    ...
    "faq": [
      ...
      {
        "q": "Wie rühre ich das Pulver für einen Ansatz an?",
        "a": "{powder_parts} Teil Pulver auf {water_parts} Teile Wasser, nach Gewicht. Für einen Ansatz sind das {powder_dose} g Pulver und {water_dose} g Wasser. Die Faustregel pro Eiweiß: {white_powder} g Pulver + {white_water} ml Wasser = 1 Eiweiß = {white_liquid} g flüssiges Aquafaba. Nehmen Sie kaltes Wasser oder kühlen Sie die Mischung vor dem Mixen auf {chill} °C."
      },
      {
  ...
  "baking": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "{powder_parts} Teil Pulver auf {water_parts} Teile Wasser, nach Gewicht. Die Faustregel pro Eiweiß: {white_powder} g Pulver + {white_water} ml Wasser = 1 Eiweiß = {white_liquid} g flüssiges Aquafaba. Für aufgeschlagene Massen kühlen Sie die Mischung auf {chill} °C, bevor sie in die Maschine kommt."
      },
      {
  ...
  "macarons": {
    ...
    "faq": [
      ...
      {
        "q": "Wie rühre ich das Pulver für einen Ansatz an?",
        "a": "{powder_parts} Teil Pulver auf {water_parts} Teile Wasser, nach Gewicht. Für einen Ansatz sind das {powder_dose} g Pulver und {water_dose} g Wasser. Kühlen Sie die Mischung vor dem Aufschlagen. Die Faustregel pro Eiweiß: {white_powder} g Pulver + {white_water} ml Wasser = 1 Eiweiß = {white_liquid} g flüssiges Aquafaba."
      },
      {
