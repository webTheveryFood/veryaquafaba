...
export default {
  "cocktails": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Le liquide ouvert se garde fermé au réfrigérateur, à {opened_temp} °C maximum, et s'utilise dans les {opened_days} jours. La poudre ouverte se conserve tant que le sachet reste au sec et bien fermé. Non ouverts, les deux formats se gardent {unopened_months} mois à température ambiante."
      },
      {
      ...
      },
      {
        ...
        "a": "Mélangez {powder_parts} part de poudre avec {water_parts} parts d'eau, en poids, soit {powder_dose} g de poudre et {water_dose} g d'eau pour un cocktail. Reconstituez-la à l'avance et mettez-la au frais avant le service. La règle par blanc d'œuf : {white_powder} g de poudre + {white_water} ml d'eau = 1 blanc d'œuf = {white_liquid} g d'aquafaba liquide."
      },
      {
  ...
  "meringue": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Le liquide ouvert se garde fermé, à {opened_temp} °C maximum, et s'utilise dans les {opened_days} jours. La poudre ouverte se conserve tant que le sachet reste au sec et bien fermé. Avant ouverture, les deux formats se gardent {unopened_months} mois à température ambiante."
      },
      {
      ...
      },
      {
        ...
        "a": "Mélangez {powder_parts} part de poudre avec {water_parts} parts d'eau, en poids, soit {powder_dose} g de poudre et {water_dose} g d'eau pour une préparation. Refroidissez le mélange à {chill} °C avant de le fouetter. La règle par blanc d'œuf : {white_powder} g de poudre + {white_water} ml d'eau = 1 blanc d'œuf = {white_liquid} g d'aquafaba liquide."
      },
      {
  ...
  "chocolate-mousse": {
    ...
    "faq": [
      ...
      {
        "q": "Comment reconstituer la poudre pour une préparation ?",
        "a": "Mélangez {powder_parts} part de poudre avec {water_parts} parts d'eau, en poids, soit {powder_dose} g de poudre et {water_dose} g d'eau pour une préparation. Refroidissez le mélange avant de le fouetter. La règle par blanc d'œuf : {white_powder} g de poudre + {white_water} ml d'eau = 1 blanc d'œuf = {white_liquid} g d'aquafaba liquide."
      },
      {
  ...
  "mayonnaise": {
    ...
    "faq": [
      ...
      {
        "q": "Comment reconstituer la poudre pour une préparation ?",
        "a": "Mélangez {powder_parts} part de poudre avec {water_parts} parts d'eau, en poids, soit {powder_dose} g de poudre et {water_dose} g d'eau pour une préparation. La règle par blanc d'œuf : {white_powder} g de poudre + {white_water} ml d'eau = 1 blanc d'œuf = {white_liquid} g d'aquafaba liquide. Utilisez de l'eau froide, ou refroidissez le mélange à {chill} °C avant de mixer."
      },
      {
  ...
  "baking": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Mélangez {powder_parts} part de poudre avec {water_parts} parts d'eau, en poids. La règle par blanc d'œuf : {white_powder} g de poudre + {white_water} ml d'eau = 1 blanc d'œuf = {white_liquid} g d'aquafaba liquide. Pour les préparations montées, refroidissez le mélange à {chill} °C avant de le fouetter."
      },
      {
