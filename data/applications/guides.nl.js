...
export default {
  "cocktails": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Geopende vloeibare aquafaba bewaart u gesloten in de koelkast op maximaal {opened_temp} °C en gebruikt u binnen {opened_days} dagen. Geopend poeder blijft goed zolang het zakje droog en gesloten blijft. Ongeopend zijn beide formaten {unopened_months} maanden houdbaar op kamertemperatuur."
      },
      {
      ...
      },
      {
        ...
        "a": "Meng {powder_parts} deel poeder met {water_parts} delen water op gewicht, dus {powder_dose} g poeder en {water_dose} g water voor één cocktail. Maak het vooraf aan en zet het koud voor de service. De regel per eiwit: {white_powder} g poeder + {white_water} ml water = 1 eiwit = {white_liquid} g vloeibare aquafaba."
      },
      {
  ...
  "meringue": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Geopende vloeibare aquafaba bewaart u gesloten op maximaal {opened_temp} °C en gebruikt u binnen {opened_days} dagen. Geopend poeder blijft goed zolang het zakje droog en gesloten blijft. Ongeopend zijn beide formaten {unopened_months} maanden houdbaar op kamertemperatuur."
      },
      {
      ...
      },
      {
        ...
        "a": "Meng {powder_parts} deel poeder met {water_parts} delen water op gewicht, dus {powder_dose} g poeder en {water_dose} g water voor één bereiding. Koel het mengsel tot {chill} °C voor het de mixer in gaat. De regel per eiwit: {white_powder} g poeder + {white_water} ml water = 1 eiwit = {white_liquid} g vloeibare aquafaba."
      },
      {
  ...
  "chocolate-mousse": {
    ...
    "faq": [
      ...
      {
        "q": "Hoe maak ik het poeder aan voor één bereiding?",
        "a": "Meng {powder_parts} deel poeder met {water_parts} delen water op gewicht, dus {powder_dose} g poeder en {water_dose} g water voor één bereiding. Zet het koud voor het de mixer in gaat. De regel per eiwit: {white_powder} g poeder + {white_water} ml water = 1 eiwit = {white_liquid} g vloeibare aquafaba."
      },
      {
  ...
  "mayonnaise": {
    ...
    "faq": [
      ...
      {
        "q": "Hoe maak ik het poeder aan voor één bereiding?",
        "a": "Meng {powder_parts} deel poeder met {water_parts} delen water op gewicht, dus {powder_dose} g poeder en {water_dose} g water voor één bereiding. De regel per eiwit: {white_powder} g poeder + {white_water} ml water = 1 eiwit = {white_liquid} g vloeibare aquafaba. Gebruik koud water, of koel het tot {chill} °C voor u gaat mixen."
      },
      {
  ...
  "baking": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Meng {powder_parts} deel poeder met {water_parts} delen water op gewicht. De regel per eiwit: {white_powder} g poeder + {white_water} ml water = 1 eiwit = {white_liquid} g vloeibare aquafaba. Voor opgeklopt gebak koelt u het tot {chill} °C voor het de mixer in gaat."
      },
      {
  ...
  "macarons": {
    ...
    "faq": [
      ...
      {
        "q": "Hoe maak ik het poeder aan voor één bereiding?",
        "a": "Meng {powder_parts} deel poeder met {water_parts} delen water op gewicht, dus {powder_dose} g poeder en {water_dose} g water voor één bereiding. Koel het voor u gaat kloppen. De regel per eiwit: {white_powder} g poeder + {white_water} ml water = 1 eiwit = {white_liquid} g vloeibare aquafaba."
      },
      {
