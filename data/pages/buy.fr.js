...
export const buyFr = {
  ...
  hero: {
    ...
    products: [
      { ...buyEn.hero.products[0], titleImage: '/wp-content/uploads/2025/09/VERYAQUAFABA_TITLE_FR_POUDRE-02.svg', titleAlt: '' },
    ...
    items: [
      {
        ...
        altWord: 'POUDRE',
        lines: [['30 g SACHET', '= 15 blancs d’œufs'], ['200 g SACHET', '= 100 blancs d’œufs'], ['3kg SAC', '= 1 500 blancs d’œufs']],
      },
      {
        ...buyEn.formats.items[1],
        titleImage: '/wp-content/uploads/2025/09/VERYAQUAFABA_TITLE_FR_LIQUIDE-DOUBLE.svg',
        altWord: 'LIQUIDE',
        lines: [['1L TETRAPAK', '= 33 blancs d’œufs'], ['10L BAG-IN-BOX', '= 330 blancs d’œufs'], ['1T IBC', '= 33.000 blancs d’œufs']],
      },
    ],
  ...
  faq: {
    ...
    items: [
      ...
      ['Q : Puis-je le faire moi-même ?', 'R : OUI, conservez l’eau de cuisson des pois chiches et réduisez-la si elle est trop liquide.'],
      ['Q : Qu’est-ce que VERY AQUAFABA ?', 'R : Une version standardisée pour un usage professionnel et industriel.'],
      ['Q : Quelle quantité équivaut à un œuf ?', 'R : VERY AQUAFABA Liquide 1 L ≈ 33 blancs d’œufs\n⮕ 1 blanc d’œuf ≈ 30 g de liquide\nVERY AQUAFABA Poudre 200 g ≈ 100 blancs d’œufs\n⮕ 1 blanc d’œuf ≈ 2 g de poudre'],
