...
6. Write in the requested language only, formal register, professional and concrete. Short sentences.
   ...
   The 1 T IBC and the 5 L bag-in-box are LIQUID formats: never place them with the powder.
...
export function factsProse(facts, app) {
  ...
  return [
    ...
    r?.publicar ? `Powder reconstitution, printed on the page: ${r.egg_white_powder_g} g of powder + ${r.egg_white_water_ml} ml of water = one egg white = ${r.egg_white_liquid_g} g of liquid aquafaba. Refer to it as "the proportion shown in the key figures".` : 'Powder preparation: not published.',
    ...
    'Formats: 1 L Tetrapak (liquid), 5 L bag-in-box (liquid, foodservice and industry), 1 T IBC (liquid, industrial lines, on request), 200 g pouch (powder).',
...
- No digits and no numbers in words (except the pack names "1 L", "5 L", "200 g", "1 T").
