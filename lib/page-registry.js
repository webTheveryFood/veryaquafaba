...
import { APPLICATION_ROOTS, APPLICATION_ALIASES, RESOURCES_ROOTS } from '../data/applications/routes';
...
function typeForRoute(route, locale) {
  ...
  if (appRoot && route.startsWith(appRoot)) return 'application';
...
export const PROGRAMMATIC_PAGE_TYPES = ['home', 'about', 'buy', 'recipe-index', 'recipe', 'application', 'resources'];
