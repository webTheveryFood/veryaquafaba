...
import { APPLICATION_ROOTS, APPLICATION_ALIASES, CHILD_ALIASES, RESOURCES_ROOTS, SECTION_ROOTS, TOPIC_ALIASES } from '../data/applications/routes';

const RESOURCES_ROUTES = new Set(Object.values(RESOURCES_ROOTS));
