...
import { APPLICATION_ROOTS, APPLICATION_ALIASES, CHILD_ALIASES, RESOURCES_ROOTS } from '../data/applications/routes';
...
export const PROGRAMMATIC_PAGE_TYPES = ['home', 'about', 'buy', 'recipe-index', 'recipe', 'application', 'application-index', 'application-child', 'resources'];
