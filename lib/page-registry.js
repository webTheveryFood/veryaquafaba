...
import { APPLICATION_ROOTS, APPLICATION_ALIASES } from '../data/applications/routes';
...
export const PROGRAMMATIC_PAGE_TYPES = ['home', 'about', 'buy', 'recipe-index', 'recipe', 'application'];
