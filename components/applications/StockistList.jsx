...
// Where-to-buy page of one country (set-2): the country's real channels, each with its link
// and what its listing carries, then the technical sheet CTA and the professional enquiry
// links. Amazon and InstantChef carry their click goal and tracking parameters; every other
// distributor carries data-cta="distributor" for the panel's rule goal.
